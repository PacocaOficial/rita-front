...
export default function DeleteUser() {
    ...
    return (
        <div className="space-y-6">
            <HeadingSmall title="Apagar Conta" description="Remove a conta e todos os dados permanentemente" />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                    <p className="font-medium">Atenção</p>
                    <p className="text-sm">Sua conta será apagada, inclusive informações sobre pagamentos e sua conta da rede social Paçoca. Não é possível recuperar essa ação</p>
                </div>
